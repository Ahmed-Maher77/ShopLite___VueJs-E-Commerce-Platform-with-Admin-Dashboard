...
<template>
  <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-20 relative group">
    ...
    <div class="relative overflow-hidden">
      ...
      <button 
        @click="prev" 
        class="absolute left-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/90 shadow-md rounded-full flex items-center justify-center text-gray-800 hover:text-secondary hover:scale-110 transition-all opacity-0 group-hover:opacity-100 disabled:opacity-50 disabled:cursor-not-allowed"
      >
      ...
      <button 
        @click="next" 
        class="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/90 shadow-md rounded-full flex items-center justify-center text-gray-800 hover:text-secondary hover:scale-110 transition-all opacity-0 group-hover:opacity-100 disabled:opacity-50 disabled:cursor-not-allowed"
      >
