  ...
  >
    ...
    <div class="absolute top-3 left-3 z-10 flex flex-col gap-1.5">
      ...
      <span 
        ...
        class="bg-secondary text-white text-[10px] font-bold px-2 py-0.5 rounded shadow-sm"
      >
      ...
      <span 
        ...
        class="bg-amber-500 text-white text-[10px] font-bold px-2 py-0.5 rounded shadow-sm"
      >
    ...
    <div class="p-4 flex flex-col flex-grow text-left">
      ...
      <!-- Title -->
      <h3 class="text-sm font-semibold text-gray-800 group-hover:text-secondary transition-colors line-clamp-2 leading-tight mb-2 h-[36px]">
      ...
      <div class="mt-auto pt-2 flex items-center justify-between border-t border-gray-50">
        ...
        <!-- Action Button -->
        <span class="text-xs font-semibold text-gray-600 group-hover:text-secondary group-hover:underline transition-colors flex items-center gap-0.5">
          Details &rarr;
        </span>
      </div>
    </div>
