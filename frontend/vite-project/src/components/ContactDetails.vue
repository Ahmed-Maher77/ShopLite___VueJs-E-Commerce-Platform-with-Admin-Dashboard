          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-10">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500 leading-relaxed">
                <a href="tel:+12322233344" class="block hover:text-secondary transition-colors">+123 222 333 44</a>
                <a href="mailto:info@yourinfo.com" class="block hover:text-secondary transition-colors underline">info@yourinfo.com</a>
              </p>
            </div>
            ...
            <div>
              ...
              <p class="text-sm text-gray-500 leading-relaxed">
                <a href="tel:+12366677788" class="block hover:text-secondary transition-colors">+123 666 777 88</a>
                <a href="mailto:info@yourinfo.com" class="block hover:text-secondary transition-colors underline">info@yourinfo.com</a>
              </p>
            </div>
          </div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <input 
                ...
                required 
                class="w-full border border-gray-200 py-3.5 px-4 rounded text-sm text-gray-800 placeholder-gray-400 focus:border-secondary focus:ring-0 focus:outline-none transition-colors"
              />
            </div>
            <div>
              <input 
          ...
          <div>
            <textarea 
              ...
              rows="5" 
              required 
              class="w-full border border-gray-200 py-3.5 px-4 rounded text-sm text-gray-800 placeholder-gray-400 focus:border-secondary focus:ring-0 focus:outline-none transition-colors resize-none"
            ></textarea>
          </div>
          ...
          <div class="pt-2">
            <button 
              ...
              class="bg-secondary text-white py-3.5 px-8 text-xs font-semibold tracking-widest uppercase rounded hover:bg-secondary/90 transition-colors cursor-pointer w-full sm:w-auto text-center disabled:opacity-50 disabled:cursor-not-allowed"
            >
