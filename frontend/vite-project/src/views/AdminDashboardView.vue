      ...
      <div class="p-6">
        ...
        <nav class="space-y-1.5">
          <button 
            ...
            :class="activeSection === 'overview' ? 'bg-secondary/15 text-secondary' : 'text-gray-600 hover:bg-gray-50'"
          >
          ...
          <button 
            ...
            class="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-semibold transition-all cursor-pointer"
            :class="activeSection === 'products' ? 'bg-secondary/15 text-secondary' : 'text-gray-600 hover:bg-gray-50'"
          >
          ...
          <button 
            ...
            class="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-semibold transition-all cursor-pointer"
            :class="activeSection === 'users' ? 'bg-secondary/15 text-secondary' : 'text-gray-600 hover:bg-gray-50'"
          >
          ...
          <button 
            ...
            class="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-semibold transition-all cursor-pointer"
            :class="activeSection === 'categories' ? 'bg-secondary/15 text-secondary' : 'text-gray-600 hover:bg-gray-50'"
          >
          ...
          <button 
            ...
            class="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-semibold transition-all cursor-pointer"
            :class="activeSection === 'orders' ? 'bg-secondary/15 text-secondary' : 'text-gray-600 hover:bg-gray-50'"
          >
          ...
          <button 
            ...
            class="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-semibold transition-all cursor-pointer"
            :class="activeSection === 'coupons' ? 'bg-secondary/15 text-secondary' : 'text-gray-600 hover:bg-gray-50'"
          >
          ...
          <button 
            ...
            class="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-semibold transition-all cursor-pointer"
            :class="activeSection === 'homepage' ? 'bg-secondary/15 text-secondary' : 'text-gray-600 hover:bg-gray-50'"
          >
      ...
      <div v-if="activeSection === 'overview'" class="space-y-8">
        ...
        <div class="bg-white border border-gray-100 rounded-lg p-6 shadow-sm">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <!-- Products CRUD nav -->
            <div @click="activeSection = 'products'; fetchProducts()" class="border border-gray-100 hover:border-secondary/30 p-5 rounded-lg hover:shadow-sm transition-all cursor-pointer text-left bg-gray-50/50">
              <Package class="w-8 h-8 text-secondary mb-3" />
            ...
            <!-- Users nav -->
            <div @click="activeSection = 'users'; fetchUsers()" class="border border-gray-100 hover:border-secondary/30 p-5 rounded-lg hover:shadow-sm transition-all cursor-pointer text-left bg-gray-50/50">
            ...
            <!-- Categories nav -->
            <div @click="activeSection = 'categories'; fetchCategories()" class="border border-gray-100 hover:border-secondary/30 p-5 rounded-lg hover:shadow-sm transition-all cursor-pointer text-left bg-gray-50/50">
            ...
            <!-- Orders nav -->
            <div @click="activeSection = 'orders'; fetchOrders()" class="border border-gray-100 hover:border-secondary/30 p-5 rounded-lg hover:shadow-sm transition-all cursor-pointer text-left bg-gray-50/50">
            ...
            <!-- Coupons nav -->
            <div @click="activeSection = 'coupons'; fetchCoupons()" class="border border-gray-100 hover:border-secondary/30 p-5 rounded-lg hover:shadow-sm transition-all cursor-pointer text-left bg-gray-50/50">
            ...
            <!-- Homepage CMS nav -->
            <div @click="activeSection = 'homepage'" class="border border-gray-100 hover:border-secondary/30 p-5 rounded-lg hover:shadow-sm transition-all cursor-pointer text-left bg-gray-50/50">
      ...
      <div v-else-if="activeSection === 'products'" class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-between items-stretch sm:items-center bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
          <div class="flex flex-1 gap-3">
            <div class="relative flex-grow max-w-md">
              ...
              <input 
                ...
                class="w-full bg-white border border-gray-250 rounded-md pl-9 pr-3 py-2 text-sm focus:outline-none focus:border-secondary transition-all"
              />
            </div>
            ...
            <select 
              ...
              class="bg-white border border-gray-250 rounded-md px-3 py-2 text-sm focus:outline-none focus:border-secondary"
            >
          ...
          <button 
            ...
            class="bg-secondary text-white font-bold text-xs py-2.5 px-6 rounded uppercase shadow hover:opacity-95 active:scale-95 transition-all flex items-center justify-center gap-1 cursor-pointer"
          >
          ...
          <table class="w-full text-left border-collapse">
            ...
            <tbody class="text-sm text-gray-600 divide-y divide-gray-50">
              <tr v-for="prod in productsList" :key="prod._id" class="hover:bg-gray-50/50">
                ...
                <td class="p-4">
                  <span class="bg-secondary/10 text-secondary text-xs font-bold px-2 py-0.5 rounded">
                ...
                <td class="p-4 text-right">
                  <div class="flex justify-end gap-1.5">
                    <button 
                      ...
                      class="p-1.5 hover:bg-secondary/10 text-secondary rounded cursor-pointer transition-colors"
                      title="Edit"
                    >
                      <Edit2 class="w-4 h-4" />
                    </button>
              ...
              <tr v-for="usr in usersList" :key="usr._id" class="hover:bg-gray-50/50">
                ...
                <td class="p-4">
                  <select 
                    ...
                    class="bg-white border border-gray-200 rounded px-2 py-1 text-xs font-semibold focus:outline-none focus:border-secondary"
          ...
          <table class="w-full text-left border-collapse">
            ...
            <tbody class="text-sm text-gray-600 divide-y divide-gray-50">
              <tr v-for="coup in couponsList" :key="coup._id" class="hover:bg-gray-50/50">
                <td class="p-4 font-mono font-extrabold tracking-wider text-secondary">{{ coup.code }}</td>
      ...
      <div v-else-if="activeSection === 'homepage'" class="space-y-6">
        <div class="bg-white border border-gray-100 rounded-lg p-8 shadow-sm text-left max-w-xl">
          <h2 class="text-base font-bold text-gray-800 uppercase tracking-wider mb-6 flex items-center gap-1.5 border-b border-gray-100 pb-3">
            <Sparkles class="w-5 h-5 text-secondary" /> Homepage Hero Banner Configuration
          </h2>
          ...
          <div class="space-y-4">
            <div>
              ...
              <input 
                ...
                type="text" 
                class="w-full bg-white border border-gray-250 rounded-md py-2 px-3 text-sm focus:outline-none focus:border-secondary transition-all font-semibold"
              />
            </div>
            ...
            <div>
              ...
              <input 
                ...
                type="text" 
                class="w-full bg-white border border-gray-250 rounded-md py-2 px-3 text-sm focus:outline-none focus:border-secondary transition-all"
              />
            </div>
            ...
            <button 
              ...
              class="w-full bg-secondary text-white font-bold text-xs tracking-wider py-3.5 px-6 rounded uppercase shadow hover:opacity-95 active:scale-95 transition-all cursor-pointer flex items-center justify-center gap-1"
            >
      ...
      <div class="bg-white rounded-lg max-w-2xl w-full shadow-2xl overflow-hidden border border-gray-150 text-left flex flex-col max-h-[90vh]">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="flex items-center gap-3 mt-4 col-span-2">
              <label class="flex items-center gap-2 select-none cursor-pointer">
                <input v-model="productForm.isFeatured" type="checkbox" class="accent-secondary cursor-pointer" /> Featured product
              </label>

              <label class="flex items-center gap-2 select-none cursor-pointer">
                <input v-model="productForm.isOnSale" type="checkbox" class="accent-secondary cursor-pointer" /> On Sale promo
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="p-6 border-t border-gray-100 bg-gray-55 flex justify-end gap-3">
          ...
          <button 
            ...
            class="bg-secondary text-white py-2 px-6 rounded text-xs font-bold uppercase hover:opacity-95 shadow flex items-center justify-center gap-1 cursor-pointer disabled:opacity-50"
          >
