        ...
        <form @submit.prevent="handleSubmit" class="space-y-6 text-left">
          ...
          <div>
            ...
            <div class="mt-1 relative rounded shadow-sm">
              ...
              <input 
                ...
                v-model="form.email"
                type="text" 
                class="w-full bg-white border border-gray-200 rounded-md pl-10 pr-3 py-2 text-sm focus:outline-none focus:border-secondary focus:ring-1 focus:ring-secondary transition-all"
          ...
          <div>
            ...
            <div class="mt-1 relative rounded shadow-sm">
              ...
              <input 
                ...
                class="w-full bg-white border border-gray-200 rounded-md pl-10 pr-10 py-2 text-sm focus:outline-none focus:border-secondary focus:ring-1 focus:ring-secondary transition-all"
          ...
          <div class="flex items-center justify-between text-xs">
            <label class="flex items-center gap-2 text-gray-600 select-none cursor-pointer">
              <input type="checkbox" class="accent-secondary rounded cursor-pointer" /> Remember me
            </label>
          </div>
          ...
          <div>
            <button 
              type="submit" 
              :disabled="loading"
              class="w-full bg-secondary text-white font-bold text-sm tracking-wide py-3 px-4 rounded-md shadow-sm hover:opacity-95 active:scale-[0.99] transition-all flex justify-center items-center gap-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
