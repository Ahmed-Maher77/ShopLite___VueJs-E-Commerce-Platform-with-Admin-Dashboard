    ...
    <section class="bg-gray-50 text-center py-16 mb-16 w-full">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-gray-500 text-sm">
          <router-link to="/" class="hover:text-secondary">Home</router-link> 
          &gt; 
          <router-link to="/shop" class="hover:text-secondary">Shop</router-link>
        </p>
      </div>
    </section>
      ...
      <div v-if="checkoutSuccess && orderDetails" class="bg-white border border-emerald-100 p-10 text-center max-w-2xl mx-auto rounded-none mb-16">
        ...
        <div class="bg-gray-50 p-6 text-left text-sm space-y-3 mb-8 border border-gray-100">
          ...
          <div>
            ...
            <span class="text-secondary font-bold ml-2">${{ orderDetails.totalAmount?.toFixed(2) }}</span>
          </div>
          <div>
        ...
        <button 
          ...
          class="bg-secondary hover:bg-secondary/90 text-white font-semibold text-xs tracking-widest uppercase py-3 px-8 rounded-none transition-all cursor-pointer"
        >
          Continue Shopping
        </button>
      </div>
