      ...
      <div class="flex flex-col lg:flex-row gap-8">
        ...
        <aside class="hidden lg:block w-64 shrink-0 bg-white p-6 rounded-lg border border-gray-100 shadow-sm h-fit self-start sticky top-4">
          <div class="flex items-center justify-between border-b border-gray-100 pb-4 mb-6">
            ...
            <button 
              ...
              @click="resetFilters" 
              class="text-xs text-secondary hover:underline flex items-center gap-1 font-semibold"
            >
          ...
          <div class="mb-6">
            ...
            <div class="relative">
              <input 
                ...
                class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm pr-9 focus:outline-none focus:border-secondary focus:bg-white transition-colors"
              />
              <Search 
                @click="applyFilters" 
                class="w-4 h-4 text-gray-400 absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer hover:text-secondary" 
              />
            </div>
          </div>
          ...
          <div class="mb-6">
            ...
            <div class="space-y-1 max-h-48 overflow-y-auto pr-1">
              <button 
                ...
                :class="filters.category === cat.name ? 'bg-secondary/10 text-secondary font-semibold' : 'text-gray-600'"
              >
                <span>{{ cat.name }}</span>
                <span 
                  class="text-[10px] bg-gray-100 text-gray-500 group-hover:bg-secondary/20 group-hover:text-secondary rounded px-1.5 py-0.5 transition-colors"
                  :class="filters.category === cat.name ? 'bg-secondary/20 text-secondary' : ''"
                >
                  &rarr;
                </span>
              </button>
          ...
          <div class="mb-6">
            ...
            <div class="space-y-1.5 max-h-48 overflow-y-auto pr-1">
              <label 
                ...
                :key="brand"
                class="flex items-center gap-2 text-sm text-gray-600 cursor-pointer hover:text-secondary select-none"
              >
                <input 
                  type="checkbox" 
                  :checked="isBrandSelected(brand)"
                  @change="toggleBrand(brand)"
                  class="accent-secondary rounded cursor-pointer"
                />
                <span :class="isBrandSelected(brand) ? 'text-secondary font-semibold' : ''">{{ brand }}</span>
              </label>
            </div>
          </div>
          ...
          <div class="mb-6">
            ...
            <div class="flex gap-2 items-center mb-3">
              <input 
                ...
                type="number" 
                placeholder="Min" 
                class="w-full bg-gray-50 border border-gray-200 rounded px-2.5 py-1.5 text-xs text-center focus:outline-none focus:border-secondary focus:bg-white"
              />
            ...
            <button 
              ...
              class="w-full bg-secondary text-white font-semibold text-xs py-2 rounded hover:opacity-95 transition-opacity"
            >
              Apply Price
            </button>
          </div>
          ...
          <div class="mb-6">
            ...
            <div class="space-y-1.5">
              <button 
                ...
                :class="filters.minRating === String(option.value) ? 'bg-secondary/5 border-l-2 border-secondary pl-1 font-semibold' : ''"
              >
                ...
                <span class="text-xs text-gray-600 font-medium" :class="filters.minRating === String(option.value) ? 'text-secondary' : ''">
                  {{ option.label }}
                </span>
              </button>
            </div>
            ...
            <div class="space-y-2">
              ...
              >
                <input 
                  ...
                  class="accent-secondary cursor-pointer"
                />
                <span :class="filters.stock === opt.value ? 'text-secondary font-semibold' : ''">{{ opt.label }}</span>
              </label>
            </div>
          </div>
        </aside>
        ...
        <div class="flex-grow">
          ...
          <div class="bg-white border border-gray-100 p-4 rounded-lg shadow-sm mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div class="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
              ...
              >
                ...
                <span v-if="activeFiltersCount > 0" class="bg-secondary text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold">
                  {{ activeFiltersCount }}
                </span>
              </button>
              ...
              <div class="flex items-center gap-2">
                ...
                <select 
                  ...
                  @change="applyFilters"
                  class="bg-white border border-gray-200 rounded px-3 py-1.5 text-sm text-gray-700 focus:outline-none focus:border-secondary cursor-pointer"
                >
          ...
          >
            ...
            <button 
              @click="resetFilters" 
              class="bg-secondary text-white font-semibold text-sm py-3 px-8 rounded shadow hover:opacity-95 active:scale-95 transition-all flex items-center gap-2"
            >
              Reset All Filters
            </button>
          </div>
          ...
          >
            <button 
              ...
              class="w-9 h-9 border border-gray-200 rounded flex items-center justify-center text-gray-600 hover:border-secondary hover:text-secondary disabled:opacity-40 disabled:hover:border-gray-200 disabled:hover:text-gray-600 disabled:cursor-not-allowed transition-colors bg-white shadow-sm"
            >
          ...
          >
            <div class="w-screen max-w-xs bg-white p-6 shadow-xl flex flex-col h-full overflow-y-auto">
              ...
              <button 
                ...
                class="w-full mb-6 py-2 border border-secondary/20 bg-secondary/5 rounded text-xs text-secondary font-bold hover:bg-secondary/10 flex items-center justify-center gap-1.5 transition-colors"
              >
              ...
              <div class="mb-6">
                ...
                <div class="relative">
                  <input 
                    ...
                    type="text" 
                    placeholder="Product name, brand..." 
                    class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm pr-9 focus:outline-none focus:border-secondary focus:bg-white"
                  />
                  <Search 
              ...
              <div class="mb-6">
                ...
                <div class="space-y-1 max-h-40 overflow-y-auto pr-1">
                  <button 
                    ...
                    :class="filters.category === cat.name ? 'bg-secondary/10 text-secondary font-semibold' : ''"
                  >
                    <span>{{ cat.name }}</span>
                    <span>&rarr;</span>
                  </button>
              ...
              <div class="mb-6">
                ...
                <div class="flex gap-2 items-center mb-3">
                  <input 
                    ...
                    type="number" 
                    placeholder="Min" 
                    class="w-full bg-gray-50 border border-gray-200 rounded px-2.5 py-1.5 text-xs text-center focus:outline-none focus:border-secondary"
                  />
                  <span class="text-gray-400 text-xs">-</span>
                  <input 
                    v-model="priceRange.max"
                ...
                <button 
                  ...
                  class="w-full bg-secondary text-white font-semibold text-xs py-2 rounded hover:opacity-95"
                >
                  Apply Price
                </button>
              </div>
              ...
              <div class="mb-6">
                ...
                <div class="space-y-2">
                  <button 
                    ...
                    :class="filters.minRating === String(option.value) ? 'bg-secondary/5 border-l-2 border-secondary font-semibold' : ''"
                  >
                    <div class="flex text-amber-400">
                      <Star 
                        v-for="n in 5" 
                    ...
                    <span class="text-xs text-gray-600" :class="filters.minRating === String(option.value) ? 'text-secondary font-bold' : ''">
                      {{ option.label }}
                    </span>
                  </button>
                </div>
