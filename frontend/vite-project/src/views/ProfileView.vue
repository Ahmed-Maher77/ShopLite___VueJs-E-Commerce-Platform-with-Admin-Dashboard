    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="bg-white border border-gray-100 p-6 rounded-lg shadow-sm h-fit text-left">
        <div class="flex items-center gap-4 border-b border-gray-100 pb-5 mb-5">
          <div class="w-16 h-16 bg-secondary/10 text-secondary rounded-full flex items-center justify-center text-2xl font-bold">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div class="border-t border-gray-100 pt-6 flex justify-end">
            <button 
              type="submit" 
              :disabled="loading"
              class="bg-secondary text-white font-bold text-sm tracking-wide py-3 px-8 rounded-md shadow-sm hover:opacity-95 active:scale-[0.99] transition-all flex justify-center items-center gap-2 cursor-pointer disabled:opacity-50"
            >
