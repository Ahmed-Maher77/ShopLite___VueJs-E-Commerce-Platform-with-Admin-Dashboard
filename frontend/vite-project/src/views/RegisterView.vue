  ...
  <div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
    <div class="sm:mx-auto sm:w-full sm:max-w-md text-center">
      ...
      <p class="mt-2 text-sm text-gray-600">
        Or
        <router-link to="/login" class="font-medium text-secondary hover:text-secondary/90 hover:underline">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4 text-left">
          ...
          <div class="pt-2">
            <button 
              type="submit" 
              :disabled="loading"
              class="w-full bg-secondary text-white font-bold text-sm tracking-wide py-3 px-4 rounded-md shadow-sm hover:opacity-95 active:scale-[0.99] transition-all flex justify-center items-center gap-2 cursor-pointer disabled:opacity-50"
            >
